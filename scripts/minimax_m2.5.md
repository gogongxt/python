...
- **模型路径**: `/nfs/ofs-llm-ssd/user/gogongxt/models/MiniMax-M2.5`
...
- **张量累计大小**: 214.32 GB
- **压缩**: 96103 → 23 行 (合并相同 shape/dtype 的 experts 和 layers)

<details><summary>详细权重列表</summary>

| 权重名称 | 形状 | 数据类型 | 大小 | 文件 |
| --- | --- | --- | --- | --- |
| `lm_head.weight` | `[200064, 3072]` | `torch.bfloat16` | 1.14 GB | model-00124-of-00126.safetensors |
| `model.embed_tokens.weight` | `[200064, 3072]` | `torch.bfloat16` | 1.14 GB | model-00000-of-00126.safetensors |
...
| `model.norm.weight` | `[3072]` | `torch.bfloat16` | 6.00 KB | model-00124-of-00126.safetensors |
