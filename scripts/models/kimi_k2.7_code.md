...
- **模型路径**: `/nfs/ofs-luban-data/model/moonshotai/Kimi-K2.7-Code`

# 模型配置

<details><summary>原始 config.json</summary>

`/nfs/ofs-luban-data/model/moonshotai/Kimi-K2.7-Code/config.json`
...
| `language_model.model.layers.0.mlp.down_proj.weight` | `[7168, 18432]` | `torch.bfloat16` | 252.00 MB | model-00001-of-000064.safetensors |
| `language_model.model.layers.0.mlp.gate_proj.weight` | `[18432, 7168]` | `torch.bfloat16` | 252.00 MB | model-00001-of-000064.safetensors |
| `language_model.model.layers.0.mlp.up_proj.weight` | `[18432, 7168]` | `torch.bfloat16` | 252.00 MB | model-00001-of-000064.safetensors |
