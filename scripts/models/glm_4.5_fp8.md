...
`/nfs/ofs-llm-ssd/models/opensource/GLM-4.5-FP8/config.json`
...
| `model.layers.92.eh_proj.weight` | `[5120, 10240]` | `torch.bfloat16` | 100.00 MB | model-00093-of-00093.safetensors |
| `model.layers.92.embed_tokens.weight` | `[151552, 5120]` | `torch.bfloat16` | 1.45 GB | model-00001-of-00093.safetensors |
| `model.layers.92.enorm.weight` | `[5120]` | `torch.bfloat16` | 10.00 KB | model-00093-of-00093.safetensors |
| `model.layers.92.hnorm.weight` | `[5120]` | `torch.bfloat16` | 10.00 KB | model-00093-of-00093.safetensors |
| `model.layers.92.shared_head.head.weight` | `[151552, 5120]` | `torch.float8_e4m3fn` | 740.00 MB | model-00092-of-00093.safetensors |
| `model.layers.92.shared_head.head.weight_scale` | `[151552, 1]` | `torch.float32` | 592.00 KB | model-00092-of-00093.safetensors |
| `model.layers.92.shared_head.norm.weight` | `[5120]` | `torch.bfloat16` | 10.00 KB | model-00093-of-00093.safetensors |
