...
- **模型路径**: `/nfs/ofs-llm-ssd/models/opensource/GLM-4.5-FP8`
...
- **权重文件**: 93 个 `safetensors` 文件
- **文件总大小**: 336.48 GB
- **权重张量数**: 88,543
- **参数总量**: 358,458,543,424
- **张量累计大小**: 336.47 GB
- **压缩**: 88543 → 45 行
...
| 权重名称 | 形状 | 数据类型 | 大小 | 文件 |
| --- | --- | --- | --- | --- |
| `lm_head.weight` | `[151552, 5120]` | `torch.bfloat16` | 1.45 GB | model-00092-of-00093.safetensors |
| `model.embed_tokens.weight` | `[151552, 5120]` | `torch.bfloat16` | 1.45 GB | model-00001-of-00093.safetensors |
| `model.layers.0-2.mlp.down_proj.weight` (×3 layers) | `[5120, 12288]` | `torch.float8_e4m3fn` | 180.00 MB | Multi Files |
| `model.layers.0-2.mlp.down_proj.weight_scale` (×3 layers) | `[5120, 1]` | `torch.float32` | 60.00 KB | Multi Files |
| `model.layers.0-2.mlp.gate_proj.weight` (×3 layers) | `[12288, 5120]` | `torch.float8_e4m3fn` | 180.00 MB | Multi Files |
| `model.layers.0-2.mlp.gate_proj.weight_scale` (×3 layers) | `[12288, 1]` | `torch.float32` | 144.00 KB | Multi Files |
| `model.layers.0-2.mlp.up_proj.weight` (×3 layers) | `[12288, 5120]` | `torch.float8_e4m3fn` | 180.00 MB | Multi Files |
| `model.layers.0-2.mlp.up_proj.weight_scale` (×3 layers) | `[12288, 1]` | `torch.float32` | 144.00 KB | Multi Files |
| `model.layers.0-92.input_layernorm.weight` (×93 layers) | `[5120]` | `torch.bfloat16` | 930.00 KB | Multi Files |
| `model.layers.0-92.post_attention_layernorm.weight` (×93 layers) | `[5120]` | `torch.bfloat16` | 930.00 KB | Multi Files |
| `model.layers.0-92.self_attn.k_norm.weight` (×93 layers) | `[128]` | `torch.bfloat16` | 23.25 KB | Multi Files |
| `model.layers.0-92.self_attn.k_proj.bias` (×93 layers) | `[1024]` | `torch.bfloat16` | 186.00 KB | Multi Files |
| `model.layers.0-92.self_attn.k_proj.weight` (×93 layers) | `[1024, 5120]` | `torch.float8_e4m3fn` | 465.00 MB | Multi Files |
| `model.layers.0-92.self_attn.k_proj.weight_scale` (×93 layers) | `[1024, 1]` | `torch.float32` | 372.00 KB | Multi Files |
| `model.layers.0-92.self_attn.o_proj.weight` (×93 layers) | `[5120, 12288]` | `torch.float8_e4m3fn` | 5.45 GB | Multi Files |
| `model.layers.0-92.self_attn.o_proj.weight_scale` (×93 layers) | `[5120, 1]` | `torch.float32` | 1.82 MB | Multi Files |
| `model.layers.0-92.self_attn.q_norm.weight` (×93 layers) | `[128]` | `torch.bfloat16` | 23.25 KB | Multi Files |
| `model.layers.0-92.self_attn.q_proj.bias` (×93 layers) | `[12288]` | `torch.bfloat16` | 2.18 MB | Multi Files |
| `model.layers.0-92.self_attn.q_proj.weight` (×93 layers) | `[12288, 5120]` | `torch.float8_e4m3fn` | 5.45 GB | Multi Files |
| `model.layers.0-92.self_attn.q_proj.weight_scale` (×93 layers) | `[12288, 1]` | `torch.float32` | 4.36 MB | Multi Files |
| `model.layers.0-92.self_attn.v_proj.bias` (×93 layers) | `[1024]` | `torch.bfloat16` | 186.00 KB | Multi Files |
| `model.layers.0-92.self_attn.v_proj.weight` (×93 layers) | `[1024, 5120]` | `torch.float8_e4m3fn` | 465.00 MB | Multi Files |
| `model.layers.0-92.self_attn.v_proj.weight_scale` (×93 layers) | `[1024, 1]` | `torch.float32` | 372.00 KB | Multi Files |
| `model.layers.3-92.mlp.experts.0-159.down_proj.weight` (×90 layers, ×160 experts) | `[5120, 1536]` | `torch.float8_e4m3fn` | 105.47 GB | Multi Files |
| `model.layers.3-92.mlp.experts.0-159.down_proj.weight_scale` (×90 layers, ×160 experts) | `[5120, 1]` | `torch.float32` | 281.25 MB | Multi Files |
| `model.layers.3-92.mlp.experts.0-159.gate_proj.weight` (×90 layers, ×160 experts) | `[1536, 5120]` | `torch.float8_e4m3fn` | 105.47 GB | Multi Files |
| `model.layers.3-92.mlp.experts.0-159.gate_proj.weight_scale` (×90 layers, ×160 experts) | `[1536, 1]` | `torch.float32` | 84.38 MB | Multi Files |
| `model.layers.3-92.mlp.experts.0-159.up_proj.weight` (×90 layers, ×160 experts) | `[1536, 5120]` | `torch.float8_e4m3fn` | 105.47 GB | Multi Files |
| `model.layers.3-92.mlp.experts.0-159.up_proj.weight_scale` (×90 layers, ×160 experts) | `[1536, 1]` | `torch.float32` | 84.38 MB | Multi Files |
| `model.layers.3-92.mlp.gate.e_score_correction_bias` (×90 layers) | `[160]` | `torch.float32` | 56.25 KB | Multi Files |
| `model.layers.3-92.mlp.gate.weight` (×90 layers) | `[160, 5120]` | `torch.bfloat16` | 140.62 MB | Multi Files |
| `model.layers.3-92.mlp.shared_experts.down_proj.weight` (×90 layers) | `[5120, 1536]` | `torch.float8_e4m3fn` | 675.00 MB | Multi Files |
| `model.layers.3-92.mlp.shared_experts.down_proj.weight_scale` (×90 layers) | `[5120, 1]` | `torch.float32` | 1.76 MB | Multi Files |
| `model.layers.3-92.mlp.shared_experts.gate_proj.weight` (×90 layers) | `[1536, 5120]` | `torch.float8_e4m3fn` | 675.00 MB | Multi Files |
| `model.layers.3-92.mlp.shared_experts.gate_proj.weight_scale` (×90 layers) | `[1536, 1]` | `torch.float32` | 540.00 KB | Multi Files |
| `model.layers.3-92.mlp.shared_experts.up_proj.weight` (×90 layers) | `[1536, 5120]` | `torch.float8_e4m3fn` | 675.00 MB | Multi Files |
| `model.layers.3-92.mlp.shared_experts.up_proj.weight_scale` (×90 layers) | `[1536, 1]` | `torch.float32` | 540.00 KB | Multi Files |
| `model.layers.92.eh_proj.weight` (×1 layers) | `[5120, 10240]` | `torch.bfloat16` | 100.00 MB | model-00093-of-00093.safetensors |
| `model.layers.92.embed_tokens.weight` (×1 layers) | `[151552, 5120]` | `torch.bfloat16` | 1.45 GB | model-00001-of-00093.safetensors |
| `model.layers.92.enorm.weight` (×1 layers) | `[5120]` | `torch.bfloat16` | 10.00 KB | model-00093-of-00093.safetensors |
| `model.layers.92.hnorm.weight` (×1 layers) | `[5120]` | `torch.bfloat16` | 10.00 KB | model-00093-of-00093.safetensors |
| `model.layers.92.shared_head.head.weight` (×1 layers) | `[151552, 5120]` | `torch.float8_e4m3fn` | 740.00 MB | model-00092-of-00093.safetensors |
| `model.layers.92.shared_head.head.weight_scale` (×1 layers) | `[151552, 1]` | `torch.float32` | 592.00 KB | model-00092-of-00093.safetensors |
| `model.layers.92.shared_head.norm.weight` (×1 layers) | `[5120]` | `torch.bfloat16` | 10.00 KB | model-00093-of-00093.safetensors |
| `model.norm.weight` | `[5120]` | `torch.bfloat16` | 10.00 KB | model-00092-of-00093.safetensors |
