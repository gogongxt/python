...
- **模型路径**: `/nfs/ofs-luban-data/model/ZhipuAI/GLM-5.2`

# 模型配置

<details><summary>原始 config.json</summary>

`/nfs/ofs-luban-data/model/ZhipuAI/GLM-5.2/config.json`
  ...
  (layers): ModuleList(
    (0-2): 3 x GlmMoeDsaDecoderLayer(
      (self_attn): GlmMoeDsaAttention(
        ...
        (kv_a_proj_with_mqa): Linear(in_features=6144, out_features=704, bias=False)
...
| `model.layers.0-2,6,10,...,74,78.self_attn.indexer.k_norm.bias` (×22 layers) | `[128]` | `torch.bfloat16` | 5.50 KB | Multi Files |
| `model.layers.0-2,6,10,...,74,78.self_attn.indexer.k_norm.weight` (×22 layers) | `[128]` | `torch.bfloat16` | 5.50 KB | Multi Files |
| `model.layers.0-2,6,10,...,74,78.self_attn.indexer.weights_proj.weight` (×22 layers) | `[32, 6144]` | `torch.bfloat16` | 8.25 MB | Multi Files |
| `model.layers.0-2,6,10,...,74,78.self_attn.indexer.wk.weight` (×22 layers) | `[128, 6144]` | `torch.bfloat16` | 33.00 MB | Multi Files |
| `model.layers.0-2,6,10,...,74,78.self_attn.indexer.wq_b.weight` (×22 layers) | `[4096, 2048]` | `torch.bfloat16` | 352.00 MB | Multi Files |
...
| `model.layers.78.eh_proj.weight` | `[6144, 12288]` | `torch.bfloat16` | 144.00 MB | model-00270-of-00282.safetensors |
| `model.layers.78.enorm.weight` | `[6144]` | `torch.bfloat16` | 12.00 KB | model-00270-of-00282.safetensors |
| `model.layers.78.hnorm.weight` | `[6144]` | `torch.bfloat16` | 12.00 KB | model-00270-of-00282.safetensors |
