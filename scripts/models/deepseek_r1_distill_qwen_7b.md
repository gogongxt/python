...
- **模型路径**: `/nfs/ofs-llm-ssd/models/opensource/DeepSeek-R1-Distill-Qwen-7B`
...
| 权重名称 | 形状 | 数据类型 | 大小 | 文件 |
| --- | --- | --- | --- | --- |
| `lm_head.weight` | `[152064, 3584]` | `torch.bfloat16` | 1.02 GB | model-00002-of-000002.safetensors |
| `model.embed_tokens.weight` | `[152064, 3584]` | `torch.bfloat16` | 1.02 GB | model-00001-of-000002.safetensors |
...
| `model.norm.weight` | `[3584]` | `torch.bfloat16` | 7.00 KB | model-00002-of-000002.safetensors |
