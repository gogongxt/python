...
- **模型路径**: `/nfs/ofs-llm-ssd/models/opensource/Qwen2.5-Coder-7B-Instruct`

# 模型配置

<details><summary>原始 config.json</summary>

`/nfs/ofs-llm-ssd/models/opensource/Qwen2.5-Coder-7B-Instruct/config.json`
...
| `model.norm.weight` | `[3584]` | `torch.bfloat16` | 7.00 KB | model-00003-of-00004.safetensors |
