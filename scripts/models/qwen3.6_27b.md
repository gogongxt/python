...
| `model.language_model.layers.0-62.linear_attn.A_log` (×48 layers) | `[48]` | `torch.bfloat16` | 4.50 KB | Multi Files |
| `model.language_model.layers.0-62.linear_attn.conv1d.weight` (×48 layers) | `[10240, 1, 4]` | `torch.bfloat16` | 3.75 MB | Multi Files |
| `model.language_model.layers.0-62.linear_attn.dt_bias` (×48 layers) | `[48]` | `torch.bfloat16` | 4.50 KB | Multi Files |
| `model.language_model.layers.0-62.linear_attn.in_proj_a.weight` (×48 layers) | `[48, 5120]` | `torch.bfloat16` | 22.50 MB | Multi Files |
| `model.language_model.layers.0-62.linear_attn.in_proj_b.weight` (×48 layers) | `[48, 5120]` | `torch.bfloat16` | 22.50 MB | Multi Files |
...
| `model.language_model.layers.0-62.linear_attn.norm.weight` (×48 layers) | `[128]` | `torch.bfloat16` | 12.00 KB | Multi Files |
...
| `model.language_model.layers.3-63.self_attn.k_norm.weight` (×16 layers) | `[256]` | `torch.bfloat16` | 8.00 KB | Multi Files |
| `model.language_model.layers.3-63.self_attn.k_proj.weight` (×16 layers) | `[1024, 5120]` | `torch.bfloat16` | 160.00 MB | Multi Files |
| `model.language_model.layers.3-63.self_attn.o_proj.weight` (×16 layers) | `[5120, 6144]` | `torch.bfloat16` | 960.00 MB | Multi Files |
| `model.language_model.layers.3-63.self_attn.q_norm.weight` (×16 layers) | `[256]` | `torch.bfloat16` | 8.00 KB | Multi Files |
| `model.language_model.layers.3-63.self_attn.q_proj.weight` (×16 layers) | `[12288, 5120]` | `torch.bfloat16` | 1.88 GB | Multi Files |
| `model.language_model.layers.3-63.self_attn.v_proj.weight` (×16 layers) | `[1024, 5120]` | `torch.bfloat16` | 160.00 MB | Multi Files |
...
| `mtp.layers.0.input_layernorm.weight` (×1 layers) | `[5120]` | `torch.bfloat16` | 10.00 KB | model-00015-of-00015.safetensors |
| `mtp.layers.0.mlp.down_proj.weight` (×1 layers) | `[5120, 17408]` | `torch.bfloat16` | 170.00 MB | model-00013-of-00015.safetensors |
| `mtp.layers.0.mlp.gate_proj.weight` (×1 layers) | `[17408, 5120]` | `torch.bfloat16` | 170.00 MB | model-00013-of-00015.safetensors |
| `mtp.layers.0.mlp.up_proj.weight` (×1 layers) | `[17408, 5120]` | `torch.bfloat16` | 170.00 MB | model-00013-of-00015.safetensors |
| `mtp.layers.0.post_attention_layernorm.weight` (×1 layers) | `[5120]` | `torch.bfloat16` | 10.00 KB | model-00015-of-00015.safetensors |
| `mtp.layers.0.self_attn.k_norm.weight` (×1 layers) | `[256]` | `torch.bfloat16` | 512.00 B | model-00015-of-00015.safetensors |
| `mtp.layers.0.self_attn.k_proj.weight` (×1 layers) | `[1024, 5120]` | `torch.bfloat16` | 10.00 MB | model-00013-of-00015.safetensors |
| `mtp.layers.0.self_attn.o_proj.weight` (×1 layers) | `[5120, 6144]` | `torch.bfloat16` | 60.00 MB | model-00015-of-00015.safetensors |
| `mtp.layers.0.self_attn.q_norm.weight` (×1 layers) | `[256]` | `torch.bfloat16` | 512.00 B | model-00015-of-00015.safetensors |
| `mtp.layers.0.self_attn.q_proj.weight` (×1 layers) | `[12288, 5120]` | `torch.bfloat16` | 120.00 MB | model-00013-of-00015.safetensors |
| `mtp.layers.0.self_attn.v_proj.weight` (×1 layers) | `[1024, 5120]` | `torch.bfloat16` | 10.00 MB | model-00013-of-00015.safetensors |
