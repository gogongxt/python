...
- **模型路径**: `/nfs/ofs-luban-data/model/ZhipuAI/GLM-5.2-FP8`

# 模型配置

<details><summary>原始 config.json</summary>

`/nfs/ofs-luban-data/model/ZhipuAI/GLM-5.2-FP8/config.json`
...
- **权重文件**: 141 个 `safetensors` 文件
- **文件总大小**: 703.74 GB
- **权重张量数**: 118,629
- **参数总量**: 753,375,793,584
- **张量累计大小**: 703.72 GB
- **压缩**: 118629 → 48 行
...
| 权重名称 | 形状 | 数据类型 | 大小 | 文件 |
| --- | --- | --- | --- | --- |
| `lm_head.weight` | `[154880, 6144]` | `torch.bfloat16` | 1.77 GB | model-00001-of-00141.safetensors |
| `model.embed_tokens.weight` | `[154880, 6144]` | `torch.bfloat16` | 1.77 GB | model-00001-of-00141.safetensors |
...
| `model.layers.0-2,6,10,...,74,78.self_attn.indexer.wk.weight` (×22 layers) | `[128, 6144]` | `torch.float8_e4m3fn` | 16.50 MB | Multi Files |
| `model.layers.0-2,6,10,...,74,78.self_attn.indexer.wk.weight_scale_inv` (×22 layers) | `[1, 48]` | `torch.float32` | 4.12 KB | Multi Files |
| `model.layers.0-2,6,10,...,74,78.self_attn.indexer.wq_b.weight` (×22 layers) | `[4096, 2048]` | `torch.float8_e4m3fn` | 176.00 MB | Multi Files |
| `model.layers.0-2,6,10,...,74,78.self_attn.indexer.wq_b.weight_scale_inv` (×22 layers) | `[32, 16]` | `torch.float32` | 44.00 KB | Multi Files |
...
| `model.layers.78.eh_proj.weight` | `[6144, 12288]` | `torch.bfloat16` | 144.00 MB | model-00136-of-00141.safetensors |
| `model.layers.78.enorm.weight` | `[6144]` | `torch.bfloat16` | 12.00 KB | model-00136-of-00141.safetensors |
| `model.layers.78.hnorm.weight` | `[6144]` | `torch.bfloat16` | 12.00 KB | model-00136-of-00141.safetensors |
| `model.layers.78.shared_head.norm.weight` | `[6144]` | `torch.bfloat16` | 12.00 KB | model-00138-of-00141.safetensors |
| `model.norm.weight` | `[6144]` | `torch.bfloat16` | 12.00 KB | model-00141-of-00141.safetensors |
