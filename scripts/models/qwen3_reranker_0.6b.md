...
- **模型路径**: `/nfs/ofs-llm-ssd/models/opensource/Qwen3-Reranker-0.6B`

# 模型配置

<details><summary>原始 config.json</summary>

`/nfs/ofs-llm-ssd/models/opensource/Qwen3-Reranker-0.6B/config.json`
...
| 权重名称 | 形状 | 数据类型 | 大小 | 文件 |
| --- | --- | --- | --- | --- |
| `model.embed_tokens.weight` | `[151669, 1024]` | `torch.bfloat16` | 296.23 MB | model.safetensors |
