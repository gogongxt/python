...
| `model.layers.0-46.linear_attn.in_proj_qkvz.weight` (×36 layers) | `[12288, 2048]` | `torch.bfloat16` | 1.69 GB | Multi Files |
| `model.layers.0-46.linear_attn.norm.weight` (×36 layers) | `[128]` | `torch.bfloat16` | 9.00 KB | Multi Files |
| `model.layers.0-46.linear_attn.out_proj.weight` (×36 layers) | `[2048, 4096]` | `torch.bfloat16` | 576.00 MB | Multi Files |
...
| `model.layers.3-47.self_attn.k_proj.weight` (×12 layers) | `[512, 2048]` | `torch.bfloat16` | 24.00 MB | Multi Files |
| `model.layers.3-47.self_attn.o_proj.weight` (×12 layers) | `[2048, 4096]` | `torch.bfloat16` | 192.00 MB | Multi Files |
| `model.layers.3-47.self_attn.q_norm.weight` (×12 layers) | `[256]` | `torch.bfloat16` | 6.00 KB | Multi Files |
| `model.layers.3-47.self_attn.q_proj.weight` (×12 layers) | `[8192, 2048]` | `torch.bfloat16` | 384.00 MB | Multi Files |
| `model.layers.3-47.self_attn.v_proj.weight` (×12 layers) | `[512, 2048]` | `torch.bfloat16` | 24.00 MB | Multi Files |
...
| `mtp.layers.0.input_layernorm.weight` (×1 layers) | `[2048]` | `torch.bfloat16` | 4.00 KB | model-00041-of-00041.safetensors |
| `mtp.layers.0.mlp.experts.0-511.down_proj.weight` (×1 layers, ×512 experts) | `[2048, 512]` | `torch.bfloat16` | 1.00 GB | model-00041-of-00041.safetensors |
| `mtp.layers.0.mlp.experts.0-511.gate_proj.weight` (×1 layers, ×512 experts) | `[512, 2048]` | `torch.bfloat16` | 1.00 GB | model-00041-of-00041.safetensors |
| `mtp.layers.0.mlp.experts.0-511.up_proj.weight` (×1 layers, ×512 experts) | `[512, 2048]` | `torch.bfloat16` | 1.00 GB | model-00041-of-00041.safetensors |
| `mtp.layers.0.mlp.gate.weight` (×1 layers) | `[512, 2048]` | `torch.bfloat16` | 2.00 MB | model-00041-of-00041.safetensors |
| `mtp.layers.0.mlp.shared_expert.down_proj.weight` (×1 layers) | `[2048, 512]` | `torch.bfloat16` | 2.00 MB | model-00041-of-00041.safetensors |
| `mtp.layers.0.mlp.shared_expert.gate_proj.weight` (×1 layers) | `[512, 2048]` | `torch.bfloat16` | 2.00 MB | model-00041-of-00041.safetensors |
| `mtp.layers.0.mlp.shared_expert.up_proj.weight` (×1 layers) | `[512, 2048]` | `torch.bfloat16` | 2.00 MB | model-00041-of-00041.safetensors |
| `mtp.layers.0.mlp.shared_expert_gate.weight` (×1 layers) | `[1, 2048]` | `torch.bfloat16` | 4.00 KB | model-00041-of-00041.safetensors |
| `mtp.layers.0.post_attention_layernorm.weight` (×1 layers) | `[2048]` | `torch.bfloat16` | 4.00 KB | model-00041-of-00041.safetensors |
| `mtp.layers.0.self_attn.k_norm.weight` (×1 layers) | `[256]` | `torch.bfloat16` | 512.00 B | model-00041-of-00041.safetensors |
| `mtp.layers.0.self_attn.k_proj.weight` (×1 layers) | `[512, 2048]` | `torch.bfloat16` | 2.00 MB | model-00041-of-00041.safetensors |
| `mtp.layers.0.self_attn.o_proj.weight` (×1 layers) | `[2048, 4096]` | `torch.bfloat16` | 16.00 MB | model-00041-of-00041.safetensors |
| `mtp.layers.0.self_attn.q_norm.weight` (×1 layers) | `[256]` | `torch.bfloat16` | 512.00 B | model-00041-of-00041.safetensors |
| `mtp.layers.0.self_attn.q_proj.weight` (×1 layers) | `[8192, 2048]` | `torch.bfloat16` | 32.00 MB | model-00041-of-00041.safetensors |
| `mtp.layers.0.self_attn.v_proj.weight` (×1 layers) | `[512, 2048]` | `torch.bfloat16` | 2.00 MB | model-00041-of-00041.safetensors |
