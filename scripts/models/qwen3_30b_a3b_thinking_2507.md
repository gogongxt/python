...
`/nfs/ofs-llm-ssd/models/opensource/Qwen3-30B-A3B-Thinking-2507/config.json`
...
| `model.layers.25.mlp.experts.18-127.down_proj.weight` (×110 experts) | `[2048, 768]` | `torch.bfloat16` | 330.00 MB | model-00009-of-00016.safetensors |
| `model.layers.25.mlp.experts.19-127.gate_proj.weight` (×109 experts) | `[768, 2048]` | `torch.bfloat16` | 327.00 MB | model-00009-of-00016.safetensors |
| `model.layers.25.mlp.experts.19-127.up_proj.weight` (×109 experts) | `[768, 2048]` | `torch.bfloat16` | 327.00 MB | model-00009-of-00016.safetensors |
